...
//continue from here (see video Firebase Google Sign-In With Jetpack Compose & Clean Architecture - Android Studio Tutorial)
...
class GoogleAuth(
    ...
    private val oneTapClient: SignInClient
            ...
            fun getSignedInUser(): User? = auth.currentUser?.run {
                com.example.radarphone.ui.theme.User(
                    uid = uid,
                    username = displayName,
                    email = email,
                    password = null,
